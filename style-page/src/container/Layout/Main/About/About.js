                    ...
                    <div
                        ...
                        <div class="card" >
                            ...
                            <div class="card-body">
                                ...
                                <Link to="/profile" class="card-text">See Profile</Link>
                            </div>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="card" style={{ width: "250px ", height:"340px",float: "left" }}>
                        ...
                        <div class="card" style={{ width: "250px ", height:"340px",float: "right" ,
                            // float: "left",
                            marginLeft: "30px" }}>
                            ...
                            <div class="card-body" >
                                ...
                                <p class="card-text">More than a Developer</p>
                                <Link to="/features#section3" class="card-link">Know more</Link>
